...
const createEditPointOffersTemplate = (offers) => {
  return `${offers !== undefined ?
    `<section class="event__section  event__section--offers">
      ...
      ${offers.map(function ({title, price, inputName, isChecked}) {
    return `<div class="event__offer-selector">
    <input class="event__offer-checkbox  visually-hidden" id="${inputName}-1" type="checkbox" name="${inputName}" ${isChecked ? `checked` : ``}>
